...
const FetchRetryHeadersStrategySchema = z.object({
...
const FetchRetryBackoffStrategySchema = RetryOptionsSchema.extend({
  /** The `backoff` strategy retries the request with an exponential backoff. */
...
const FetchRetryStrategySchema = z.discriminatedUnion("strategy", [
...
const FetchRequestInitSchema = z.object({
...
const FetchRetryOptionsSchema = z.record(FetchRetryStrategySchema);
...
const FetchTimeoutOptionsSchema = z.object({
...
const FetchOperationSchema = z.object({
  url: z.string(),
...
const FetchPollOperationSchema = z.object({
  url: z.string(),
